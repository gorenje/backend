function deleteSubject(objid){
  ...
  $.ajax({
    ...
    window.location = window.location.protocol + "//" +
                      ...
                      window.location.port + "/user/searches";
  });
}
...
function setup_for_update_search() {
  current_location = new google.maps.LatLng(search_obj.location.coordinates[1],
                                            search_obj.location.coordinates[0]);
